...
/* Basic 8x8 Bitmap Font (CGA-like) */
/* 1 bit per pixel. 1 byte per row. 8 rows per char. */
/* Total: 128 chars * 8 bytes = 1024 bytes */
...
static const uint8_t font8x8_basic[128][8] = {
    ...
    {0x18, 0x1C, 0x18, 0x18, 0x18, 0x18, 0x3C, 0x00}, // 49 '1'
    ...
    {0x3C, 0x06, 0x3E, 0x66, 0x66, 0x66, 0x3C, 0x00}, // 54 '6'
    {0x7E, 0x60, 0x30, 0x18, 0x0C, 0x0C, 0x0C, 0x00}, // 55 '7'
    {0x3C, 0x66, 0x3C, 0x66, 0x66, 0x66, 0x3C, 0x00}, // 56 '8'
    {0x3C, 0x66, 0x66, 0x3E, 0x60, 0x30, 0x1E, 0x00}, // 57 '9'
    ...
    {0xFC, 0x66, 0x66, 0xFC, 0x66, 0x66, 0xFC, 0x00}, // 66 'B'
    {0x3C, 0x66, 0x06, 0x06, 0x06, 0x66, 0x3C, 0x00}, // 67 'C'
    {0xFC, 0x66, 0x66, 0x66, 0x66, 0x66, 0xFC, 0x00}, // 68 'D'
    {0x7E, 0x06, 0x06, 0x3E, 0x06, 0x06, 0x7E, 0x00}, // 69 'E'
    {0x7E, 0x06, 0x06, 0x3E, 0x06, 0x06, 0x06, 0x00}, // 70 'F'
    {0x3C, 0x66, 0x06, 0x06, 0x76, 0x66, 0x3C, 0x00}, // 71 'G'
    ...
    {0xFC, 0x66, 0x66, 0xFC, 0x06, 0x06, 0x06, 0x00}, // 80 'P'
    {0x3C, 0x66, 0x66, 0x66, 0x66, 0x36, 0x3C, 0x0E}, // 81 'Q'
    {0xFC, 0x66, 0x66, 0xFC, 0x6C, 0x66, 0xE6, 0x00}, // 82 'R'
    {0x3C, 0x66, 0x06, 0x1C, 0x30, 0x66, 0x3C, 0x00}, // 83 'S'
    {0x7E, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x00}, // 84 'T'
    {0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x00}, // 85 'U'
    {0x66, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x18, 0x00}, // 86 'V'
    {0xC6, 0xC6, 0xC6, 0xD6, 0xFE, 0xEE, 0xC6, 0x00}, // 87 'W'
    {0xC6, 0x6C, 0x38, 0x38, 0x6C, 0xC6, 0x00, 0x00}, // 88 'X'
    {0x66, 0x66, 0x66, 0x3C, 0x18, 0x18, 0x18, 0x00}, // 89 'Y'
    {0xFE, 0x06, 0x0C, 0x18, 0x30, 0x60, 0xFE, 0x00}, // 90 'Z'
    {0x3C, 0x06, 0x06, 0x06, 0x06, 0x06, 0x3C, 0x00}, // 91 '['
    {0xC0, 0x60, 0x30, 0x18, 0x0C, 0x06, 0x03, 0x00}, // 92 '\'
    {0x3C, 0x18, 0x18, 0x18, 0x18, 0x18, 0x3C, 0x00}, // 93 ']'
    {0x08, 0x1C, 0x36, 0x63, 0x00, 0x00, 0x00, 0x00}, // 94 '^'
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF}, // 95 '_'
    {0x0C, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // 96 '`'
    {0x00, 0x00, 0x7C, 0x66, 0x7C, 0x66, 0x66, 0x00}, // 97 'a'
    {0x06, 0x06, 0x5C, 0x66, 0x66, 0x66, 0x5C, 0x00}, // 98 'b'
    {0x00, 0x00, 0x3C, 0x06, 0x06, 0x06, 0x3C, 0x00}, // 99 'c'
    {0x60, 0x60, 0x3A, 0x66, 0x66, 0x66, 0x3A, 0x00}, // 100 'd'
    {0x00, 0x00, 0x3C, 0x66, 0x7E, 0x06, 0x3C, 0x00}, // 101 'e'
    {0x1C, 0x22, 0x20, 0x3E, 0x20, 0x20, 0x20, 0x00}, // 102 'f'
    {0x00, 0x00, 0x3A, 0x66, 0x66, 0x3E, 0x06, 0x3C}, // 103 'g'
    {0x06, 0x06, 0x5C, 0x66, 0x66, 0x66, 0x66, 0x00}, // 104 'h'
    {0x18, 0x00, 0x18, 0x18, 0x18, 0x18, 0x18, 0x00}, // 105 'i'
    {0x06, 0x00, 0x06, 0x06, 0x06, 0x06, 0x26, 0x1C}, // 106 'j'
    {0x06, 0x06, 0x66, 0x36, 0x1E, 0x36, 0x66, 0x00}, // 107 'k'
    {0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x00}, // 108 'l'
    {0x00, 0x00, 0xD6, 0xFE, 0xFE, 0xD6, 0xC6, 0x00}, // 109 'm'
    {0x00, 0x00, 0xDC, 0x66, 0x66, 0x66, 0x66, 0x00}, // 110 'n'
    {0x00, 0x00, 0x3C, 0x66, 0x66, 0x66, 0x3C, 0x00}, // 111 'o'
    {0x00, 0x00, 0xDC, 0x66, 0x66, 0x7C, 0x06, 0x06}, // 112 'p'
    {0x00, 0x00, 0x3A, 0x66, 0x66, 0x3E, 0x60, 0x60}, // 113 'q'
    {0x00, 0x00, 0x5C, 0x66, 0x06, 0x06, 0x06, 0x00}, // 114 'r'
    {0x00, 0x00, 0x3C, 0x60, 0x3C, 0x06, 0x3C, 0x00}, // 115 's'
    {0x10, 0x10, 0x3E, 0x10, 0x10, 0x10, 0x0C, 0x00}, // 116 't'
    ...
    {0x18, 0x0C, 0x0C, 0x07, 0x0C, 0x0C, 0x18, 0x00}, // 125 '}'
    {0x00, 0x36, 0x5C, 0x00, 0x00, 0x00, 0x00, 0x00}, // 126 '~'
